...
describe 'AuthorStandby.healthy?' do
  before do
    @instance_component = RubyAemAws::Component::AuthorStandby::EC2_COMPONENT
    @instance_name = RubyAemAws::Component::AuthorStandby::EC2_NAME
    @instance_filter = [
